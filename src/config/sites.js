...
export const SITE_PROFILES = {
  ...
  'yb-response.com': {
    ...
    colors: { bg: '#03152f', surface: '#082b59', accent: '#0066ff', accent2: '#7dd3fc', text: '#f3f9ff' },
  ...
  'yb-alert.com': {
    ...
    colors: { bg: '#240200', surface: '#4a0904', accent: '#ff2d00', accent2: '#ffb000', text: '#fff8f0' },
  ...
  'yb-check.com': {
    ...
    colors: { bg: '#f3fffb', surface: '#ffffff', accent: '#00a896', accent2: '#006d77', text: '#102a2a' },
  ...
  'yb-case.com': {
    ...
    colors: { bg: '#1d1600', surface: '#392c00', accent: '#f4b400', accent2: '#ffe082', text: '#fffdf2' },
  ...
  'yb-safe.com': {
    ...
    colors: { bg: '#041b10', surface: '#093b22', accent: '#15c46b', accent2: '#9ef0b8', text: '#f2fff7' },
  ...
  'yb-help.com': {
    ...
    colors: { bg: '#170022', surface: '#37004d', accent: '#b517ff', accent2: '#ff70d7', text: '#fff5ff' },
  ...
  'yb-watch.co.kr': {
    ...
    colors: { bg: '#00181f', surface: '#003846', accent: '#00d4ff', accent2: '#8af7ff', text: '#effdff' },
